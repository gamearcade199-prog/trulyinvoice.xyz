...
4. Remove currency symbols (₹, Rs, INR, $) from amounts
5. Remove commas from numbers
6. DETECT the currency type from symbols/text
...
- currency: Currency code (INR, USD, EUR, GBP, etc.) detected from invoice
