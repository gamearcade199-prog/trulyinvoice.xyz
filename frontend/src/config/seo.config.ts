...
export const seoConfig = {
  ...
  keywords: [
    ...
    'convert invoice to quickbooks',
    'invoice to quickbooks online',
    'invoice to quickbooks desktop',
    'quickbooks iif converter',
    'invoice to iif format',
    'quickbooks invoice import',
    'invoice to quickbooks india',
    'invoice to quickbooks csv',
    'invoice to qbo',
    'quickbooks invoice uploader',
    'bulk invoice to quickbooks',
    'invoice to quickbooks automation',
    
    // === ZOHO BOOKS EXPORT KEYWORDS ===
    'invoice to zoho books converter',
    'convert invoice to zoho books',
    'invoice to zoho books csv',
    'zoho books invoice import',
    'invoice to zoho books online',
    'invoice to zoho books india',
    'zoho books csv upload',
    'invoice to zoho books automation',
    'bulk invoice to zoho books',
    'zoho books invoice scanner',
    
    // === CSV EXPORT KEYWORDS ===
    'invoice to csv converter',
    'convert invoice to csv',
    'invoice pdf to csv',
    'invoice to csv online',
    'bulk invoice to csv',
    'invoice to csv free',
    'invoice data to csv',
    'invoice extraction to csv',
    'invoice to csv india',
    'gst invoice to csv',
    ...
    'invoice to excel for bookkeepers',
    ...
    'convert invoice to accounting software',
    'invoice to accounting format',
    ...
    rules: [
      {
        userAgent: '*',
        allow: '/',
        disallow: ['/api/', '/dashboard/', '/admin/', '/checkout/', '/payment/'],
      },
      {
        userAgent: 'Googlebot',
        allow: '/',
      ...
      offers: [
        {
          ...
          price: '0',
          priceCurrency: 'INR',
          description: '10 invoices/month - All export formats',
        },
        {
          '@type': 'Offer',
          name: 'Basic Plan',
