...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'AI-powered invoice extraction with 98% accuracy. Built for Indian businesses. GST/GSTIN compliant. Start free today.',
  ...
  twitter: {
    ...
    description: 'AI-powered invoice extraction for Indian businesses. 98% accuracy. GST compliant.',
