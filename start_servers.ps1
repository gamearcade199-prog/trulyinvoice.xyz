...
Start-Process powershell -ArgumentList "-Command", "cd 'C:\Users\akib\Desktop\trulyinvoice.in\backend'; .\venv\Scripts\Activate.ps1; `$env:GOOGLE_AI_API_KEY='AIzaSyBEnD60M9_JkSzUz_ZiBolN9pe5fDodPSE'; python -m uvicorn app.main:app --reload --port 8000" -WindowStyle Normal
